function time() {
    ...
    // 设置数字时间
    document.getElementById('shi').innerText = parseInt(hnum).toString().padStart(2,'0');// .toString().padStart(2,'0')，不足两位向前补齐
    document.getElementById('fen').innerText = parseInt(mnum).toString().padStart(2,'0');
    document.getElementById('miao').innerText = parseInt(snum).toString().padStart(2,'0');
    document.getElementById('wzday').innerText = nian + '/' + yue.toString().padStart(2,'0') + '/' + ri.toString().padStart(2,'0') + ' ' + zifu;
